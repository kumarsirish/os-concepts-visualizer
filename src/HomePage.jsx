    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: #f6f8fb; font-family: 'DM Sans', sans-serif; }
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#f6f8fb" }}>
        ...
        <div style={{ background: "#fff", borderBottom: "1px solid #d0d7de", padding: "18px 40px", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 20, fontWeight: 800, color: "#1a1a1a", lineHeight: 1.4 }}>OS Concepts Lab</div>
        ...
        <div style={{ textAlign: "center", padding: "36px 32px 28px" }}>
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 34, fontWeight: 800, color: "#1a1a1a", marginBottom: 10, lineHeight: 1.4 }}>
            Learn OS by Doing
          </div>
          ...
          {[
            ...
            <a key={href} href={href} style={{ display: "flex", width: 240 }}>
              <div className="card" style={{
                ...
                <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 17, fontWeight: 700, color: "#1a1a1a", marginBottom: 8, lineHeight: 1.4 }}>{title}</div>
